...
- Prior sensitivity (Uniform(0,1) prior on F): median 0.0734, 95% CI [0.0260, 0.1583].

## 2. Gini-Simpson F_ST (the manuscript estimator), conjugate readout

- Posterior median = 0.0178 (mean 0.0179), 95% credible interval [0.0157, 0.0201].
...
- Beta(1,10) prior (primary): max R-hat = 1.0014 (want < 1.01); min bulk ESS = 4592; min tail ESS = 4477; divergences = 0/8000 (0.00%); treedepth >= 10 = 0; min E-BFMI = 0.980 (want > 0.3).
- Uniform(0,1) prior (sensitivity refit): max R-hat = 1.0012 (want < 1.01); min bulk ESS = 4502; min tail ESS = 4789; divergences = 0/8000 (0.00%); treedepth >= 10 = 0; min E-BFMI = 0.973 (want > 0.3).
