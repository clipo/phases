...
- P(all four slopes > 0) = 0.707.
- MCMC health: max R-hat = nan, min ESS = 2042, divergences = 0.
...
- Verdict STABLE across priors (range 0.670-0.749).
...
| fst | +0.00076 | +0.263 | True |
| spatial_boundary | +0.51494 | +0.321 | True |
