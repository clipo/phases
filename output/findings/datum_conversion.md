...
|---|---|---|---|
| converted | 17 | 13 | file coordinate is PFG's UTM read as NAD83; moved to the NAD27 reading |
| near | 11 | 8 | within 100 m of that reading but not within tolerance; derivation not demonstrated; left as recorded |
| other | 4 | 3 | more than 100 m from PFG's UTM either way; left as recorded |
| no_pfg_utm | 23 | 4 | no PFG UTM to compare against; left as recorded |
...
| Castile_Landing | nan | no_pfg_utm | - | - | 0 |
| Grant | nan | no_pfg_utm | - | - | 0 |
| Holden_Lake | nan | no_pfg_utm | - | - | - |
| Lake_Cormorant | nan | no_pfg_utm | - | - | 0 |
| Beck | 13-O-7 | other | 639 | 781 | 21719 |
| Davis | 13-N-5 | other | 1926 | 1903 | 0 |
...
Assemblages moved: 13 of 28, by 209 to 209 m.

| k | same partition? | plug-in F_ST before | after |
|---|---|---|---|
| 2 | yes | 0.006240 | 0.006240 |
| 3 | yes | 0.015590 | 0.015590 |
| 4 | yes | 0.018650 | 0.018650 |
| 5 | yes | 0.018963 | 0.018963 |
| 6 | yes | 0.029482 | 0.029482 |

The partition is the same at every k listed above and the plug-in F_ST is unchanged to the printed precision
