...
Data simulated at a true s = 0.7, well above anything the basin shows, returns a posterior median of **0.824** with interval [0.234, 0.995], which covers the truth.
